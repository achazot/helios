...
<section>
	...
	<form method="post" action="AdminController"> 
		<button type="submit" name="adminops" value="browseStudents" class="btn-action">Lister les étudiants inscrit</button>
	</form>
	...
	<form method="post" action="AdminController"> 
		<button type="submit" name="adminops" value="getForm" class="btn-action">Créer un compte</button>
	</form>
